...
namespace Line.LineSDK {
    ...
    public class LineSDK: MonoBehaviour {
        ...
        /// </summary>
        public string channelID = "1657819097";

        public string universalLinkURL;
        public string redirect_uri = "http://hi-ntou-usr.cse.ntou.edu.tw:8895/LineApi/requestAccessToken";

        public string backendAccessTokenUrl = "http://hi-ntou-usr.cse.ntou.edu.tw:8895/LineApi/getLoginResult";
